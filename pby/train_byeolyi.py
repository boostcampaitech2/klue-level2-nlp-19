...
def train(args):
  ...
  training_args = TrainingArguments(
    ...
    report_to="wandb",
    run_name= f"{MODEL_NAME.split('/')[-1]} | entity marker | epoch {args.epoch} | lr {args.learning_rate} | batch {args.batch_size} | wd{args.weight_decay}"
  )
...
if __name__ == '__main__':
  ...
  parser.add_argument('--epoch', type=int, default=4, help='number of epochs to train (default: 10)')
